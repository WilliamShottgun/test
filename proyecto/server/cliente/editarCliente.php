...
$sql = 'UPDATE cliente SET nombreCliente = \'' . $valor_decodificado['data']['nombreCliente'] . '\', rutCliente = \'' . $valor_decodificado['data']['rutCliente'] . '\' WHERE idCliente = ' . $valor_decodificado['data']['idCliente'] . ';';
