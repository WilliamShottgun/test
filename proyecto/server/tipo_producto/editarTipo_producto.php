...
$sql = 'UPDATE tipo_producto SET nombreTipo_producto = \'' . $valor_decodificado['data']['nombreTipo_producto'] . '\' WHERE idTipo_producto = ' . $valor_decodificado['data']['idTipo_producto'] . ';';
